/*********************************************************************************************************************************************************
Name: InpatientOccupancyMetricAggregateLicensedBeds
...
SELECT
  CAST(29 AS INT) AS METRIC_ID
, 'Licensed Bed Occupancy'	AS METRIC_NM
...
, CAST(SUM(LicensedBedCNT) AS DECIMAL(19,5)) AS DENOMINATOR_NBR
FROM

/*********************************************************************************************************************************************************
Name: InpatientEncounterMetricAggregatePostProcedureRecoveryLengthOfStay
...
SELECT
  CAST(35 AS INT) AS METRIC_ID
, 'Post Procedure Recovery Length Of Stay'	AS METRIC_NM
...
, POST_PROCEDURE_RECOVERY_SERVICE_GROUP_NM AS SERVICE_GROUP_DSC
, NULL AS ADMISSION_SOURCE_GROUP_NM
, CURRENT_TIMESTAMP AS EDW_LAST_MODIFIED_DTS
, SUM(POST_PROCEDURE_RECOVERY_MINUTE_NBR)/60 AS NUMERATOR_NBR
, SUM(POST_PROCEDURE_RECOVERY_PATIENT_CLASS_FLG) AS DENOMINATOR_NBR
FROM
